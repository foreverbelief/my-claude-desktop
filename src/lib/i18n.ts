...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'mode.ask': '询问',
    'mode.plan': '计划',
    'mode.bypass': '全自动（跳过确认）',
    'mode.bypassConfirmTitle': '切换到全自动模式？',
    'mode.bypassConfirmMessage': 'AI 将可以执行任意命令、读写文件，无需经您确认。建议仅在完全信任的代码库中使用。',
    'mode.bypassConfirmAction': '确认切换',
    ...
    'msg.copied': '已复制！',
    'msg.editMessage': '编辑消息',
    'msg.editSave': '保存',
    'msg.editCancel': '取消',
    'msg.editPlaceholder': '编辑消息...',
    'msg.imgError': '图片加载失败',
    'msg.openLink': '在浏览器打开',
    ...
    'chat.compactStillRunning': '压缩仍在进行中，请稍候…',
    ...
    'settings.autoModelSwitch': '智能模型切换（DeepSeek）',
    'settings.autoModelSwitchHint': '根据任务复杂度自动切换 Pro（推理/规划/数学）和 Flash（简单对话）',
    ...
    'provider.discoveryTitle': '自动探测可用模型',
    'provider.discoveryHint': '使用当前端点和 API Key 读取模型列表，勾选后添加到此提供商。',
    'provider.discoverModels': '探测模型',
    'provider.discovering': '探测中...',
    'provider.discoveryCount': '检测到 {count} 个模型',
    'provider.addSelectedModels': '添加选中的 {count} 个模型',
    'provider.discoveryMissingFields': '请先填写 API 端点和 API Key',
    ...
    'provider.opusModel': 'Pro 模型',
    'provider.sonnetModel': 'Flash 模型',
    'provider.haikuModel': 'Flash 模型',
    ...
    'provider.modelIdPlaceholder': '模型名',
    'provider.modelNamePlaceholder': '模型名，如 deepseek-v4-pro',
    'provider.providerModelPlaceholder': '供应商模型名',
    'provider.addedModels': '已添加 {count} 个模型',
    'provider.modelsAlreadyExist': '所选模型已在列表中',
  ...
  en: {
    ...
    'mode.ask': 'Ask',
    'mode.plan': 'Plan',
    'mode.bypass': 'Full Auto (skip all confirmations)',
    'mode.bypassConfirmTitle': 'Switch to Full Auto mode?',
    'mode.bypassConfirmMessage': 'The AI will be able to execute arbitrary commands and read/write files without asking for your permission. Only use this in fully trusted codebases.',
    'mode.bypassConfirmAction': 'Confirm',
    ...
    'chat.compactStillRunning': 'Compaction still in progress, please wait…',
    ...
    'settings.autoModelSwitch': 'Smart Model Switch (DeepSeek)',
    'settings.autoModelSwitchHint': 'Auto-switch between Pro (reasoning/planning/math) and Flash (simple tasks) based on task complexity',
    ...
    'provider.discoveryTitle': 'Discover available models',
    'provider.discoveryHint': 'Use this endpoint and API key to read the model list, then add the models you choose.',
    'provider.discoverModels': 'Discover models',
    'provider.discovering': 'Discovering...',
    'provider.discoveryCount': '{count} models found',
    'provider.addSelectedModels': 'Add {count} selected models',
    'provider.discoveryMissingFields': 'Enter the API endpoint and API key first',
    ...
    'provider.opusModel': 'Pro model',
    'provider.sonnetModel': 'Flash model',
    'provider.haikuModel': 'Flash model',
    ...
    'provider.modelIdPlaceholder': 'Model name',
    'provider.modelNamePlaceholder': 'Model name, e.g. deepseek-v4-pro',
    'provider.providerModelPlaceholder': 'Provider model name',
    'provider.addedModels': 'Added {count} models',
    'provider.modelsAlreadyExist': 'Selected models already in the list',
